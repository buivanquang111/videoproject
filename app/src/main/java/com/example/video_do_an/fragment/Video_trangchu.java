...
import com.example.video_do_an.databinding.TrangchuBinding;
...
public class Video_trangchu extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.inflate(inflater, R.layout.trangchu,container,false);
    ...
    public class DoGetData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            try {
                ...
                adapterVideo=new AdapterTrangChu(videolist);
